    ...
    <div className="bg-[#0a0e17] text-[#e2e8f0] font-['Exo_2'] min-h-screen">
      ...
      <main className="relative z-10 max-w-7xl mx-auto py-12 px-4 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {recordings.map((rec) => (
            <div key={rec._id} className="bg-[#1a2138]/80 backdrop-blur-sm border border-[#6366f1]/20 rounded-2xl p-5 flex flex-col justify-between hover:border-[#6366f1]/40 transition-all">
              <div>
